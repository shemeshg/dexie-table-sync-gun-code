<template>
  <div>
    <p>
      <a href="https://github.com/shemeshg/dexie-table-sync-gun-code"
        >https://github.com/shemeshg/dexie-table-sync-gun-code</a
      >
    </p>
    <div>
      Application Id:
    ...
    <button v-if="!isSyncDefined" @click="doStart">Start</button>
    <div v-if="isSyncDefined">
      <p>
        If you want to recreate the Gun Store, or import astore from local table
      </p>
      <p>The sync from Gun connected store to Dexie is Auto</p>
      <p>
